...
import us_read_and_preprocess_pm as read_and_preprocess_pm
from us_read_and_preprocess_pm import TargetPM
import seoul_input
import seoul_model
...
# Model flags
flags.DEFINE_string('model', 'cnn', 'Model to train (dnn, cnn, rnn, seq2seq, transformer).')
...
def main(unused_argv):
    # Load raw data
    dir = '/home/jychoi/seoul'
    df_pm = read_and_preprocess_pm.read_pm_dataset(dir)
